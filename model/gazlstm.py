...
class GazLSTM(nn.Module):
    def __init__(self, data):
        ...
        print("gaz_emb_dim:{}".format(self.gaz_emb_dim))
        print("char_feature_dim:{}".format(char_feature_dim))
        if self.use_biword:
        ...
        if self.model_type == 'lstm':
            ...
            if self.bilstm_flag:
                self.hidden_dim *= 2
            print("lstm_hidden:{}".format(lstm_hidden))
        ...
        print("label_alphabet_size:{}".format(data.label_alphabet_size))
        if self.use_bert:
            self.bert_encoder = BertModel.from_pretrained('hfl/chinese-roberta-wwm-ext')
    ...
    def get_tags(self,gaz_list, word_inputs, biword_inputs, layer_gaz, gaz_count, gaz_chars, gaz_mask_input, gazchar_mask_input, mask, word_seq_lengths, batch_bert, bert_mask):
        ...
        if self.use_bert:
            ...
            print("word_input_cat:{}".format(word_input_cat.shape))
