...
def get_ner_fmeasure(golden_lists, predict_lists, label_type="BIEOS",printnum=True):
...
def fmeasure_from_file(golden_file, predict_file, label_type="BIEOS"):
...
def fmeasure_from_singlefile(twolabel_file, label_type="BIEOS", pred_col=-1):
